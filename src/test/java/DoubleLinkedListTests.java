...
import org.example.linkedlists.IDoubleLinkedList;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class DoubleLinkedListTests {
  private IDoubleLinkedList<String> stringList;
  private IDoubleLinkedList<Integer> integerList;
  ...
  @Test
  void testRemoveLast() {
    // Testing removeLast on String list
    stringList.addFirst("universidad");
    stringList.addLast("usfx");
    ...
    // Testing removeLast on Integer list
    integerList.addFirst(5);
    integerList.addLast(10);
